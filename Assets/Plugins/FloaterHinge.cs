...
public class FloaterHinge : MonoBehaviour 
{
	...
	void Update()
	{
		//Debug.Log(Bob.transform.position.y);
		//if(Bob.transform.position.y >= fl.waterlvl)
		//{
		/* */
		...
		//added this part cause NaN errors during 360°s
		Vector3 offset = Pivot.transform.position - this.Bob.transform.position;
	...
	public void ResetPendulumForces()
	{
